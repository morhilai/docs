...
* In this page:  
  * [Example](../../../client-api/rest-api/querying/patch-by-query#example)  
  * [Request Format](../../../client-api/rest-api/querying/patch-by-query#request-format)  
  * [Response Format](../../../client-api/rest-api/querying/patch-by-query#response-format)  
